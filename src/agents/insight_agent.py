...
def generate_insights(summary):
    ...
    return {
        "roas_trend": f"ROAS 14-day change: {roas_change_14}" if roas_change_14 is not None else "N/A",
        "ctr_pattern": f"CTR 14-day change: {ctr_change_14}" if ctr_change_14 is not None else "N/A",
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Error: reports/data_summary.json not found. Please run the Data Agent first.")
        exit()
