    ...
    for h in insights["primary_hypotheses"]:
        ...
        if name == "Creative fatigue":
            if ctr_drop is not None and ctr_drop < -10:
                ...
                evidence_summary = f"CTR drop not significant ({ctr_drop if ctr_drop is not None else 'N/A'})."
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Error: reports/insights.json not found. Please run the Insight Agent first.")
        exit()
